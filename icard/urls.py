...
from delivery.api.router import router_delivery

schema_view = get_schema_view(
    openapi.Info(
        title="Carta digital",
        default_version='v1',
        description="carta digital para hacer pedidos online",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="crispisjam@gmail.com"),
...
urlpatterns = [
    ...
    path('api/', include(router_delivery.urls)),
]
